...
(function () {
  ...
  /* ==================================================================
     ...
     previewing locally.
     ================================================================== */
  /* Scotland's own Apps Script web app. NOT YET CREATED.
     ...
     It would have posted every Scotland lead into somebody else's spreadsheet
     ...
     Replace the placeholder below with the /exec URL from the Scotland leads
     spreadsheet once that Apps Script is deployed. It must be Scotland's own
     ...
     already visited. */
  var SHEET_ENDPOINT = 'https://script.google.com/macros/s/AKfycbwBGxgK5Vt6wW80Go4-atJvaopNPJtxBQ9MCleNGVjlu8JJqAYsKPL0AO8b384EUkmXLQ/exec';
